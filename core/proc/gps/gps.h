...
//
////@brief Simple utility function to construct rotation matrices from 3 given angles (in radians)
//template<class T>
//inline void build_rotation(T ax, T ay, T az, cv::Matx<T, 3, 3> * Rx, cv::Matx<T, 3, 3> * Ry, cv::Matx<T, 3, 3> * Rz)
//{
//  typedef cv::Matx<T, 3, 3> Matx33;
//
//  if( Rx ) {
//
//    const T cx =
