...
enum VLO_VERSION
{
  ...
  VLO_VERSION_6_SLM = 600,
  VLO_VERSION_6_SLM_IMX449 = 601,
  VLO_VERSION_6_SLM_IMX479 = 602,
...
#pragma pack(push, 1)
//
struct c_vlo_scan6_slim_imx479
{
  static constexpr  uint16_t VERSION = 6U;
  static constexpr  uint32_t NUM_LAYERS = 520;
  static constexpr  uint32_t NUM_SLOTS = 960;
  static constexpr  uint32_t NUM_ECHOS = 3;
  static constexpr  uint32_t NUM_ZONES = 3;
  static constexpr  uint32_t NUM_REFERENCE_SHOTS = 2;
  ...
  struct Metadata
  {
    typedef uint8_t Metadata_EBD[150];
    Metadata_EBD embeddedMetaData;
    uint8_t _padding1[2];
  ...
  uint16_t ambientLight[NUM_SLOTS][NUM_LAYERS];
...
template<> struct c_vlo_scan_type_traits<c_vlo_scan6_slim_imx479> {
  static constexpr VLO_VERSION VERSION = VLO_VERSION_6_SLM_IMX479;
};
