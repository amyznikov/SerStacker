...
protected:
  ...
  QCheckBox * replace_planetary_disk_with_mask_ctl = Q_NULLPTR;
  QNumberEditBox * planetary_disk_mask_stdev_factor_ctl = Q_NULLPTR;
  QWidgetList controls;
};
...
protected:
  ...
  QNumberEditBox * num_orientations_ctl = Q_NULLPTR;
