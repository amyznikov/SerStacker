...
public:
  ...
  void set_input_options(c_image_stacking_input_options * options);
  c_image_stacking_input_options * input_options() const;
...
protected:
  c_image_stacking_input_options * options_ = nullptr;
