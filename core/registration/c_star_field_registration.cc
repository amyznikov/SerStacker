...
{
  if ( !detect_stars(feature_image, feature_mask, reference_keypoints_, enable_debug_ ? debug_path_ : "") ) {
...
{
  if ( !detect_stars(current_feature_image, current_feature_mask, current_keypoints_, enable_debug_ ? debug_path_ : "") ) {
