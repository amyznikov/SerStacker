...
void QMasterFrameOptions::set_current_pipeline(const c_image_stacking_pipeline::sptr & current_pipeline)
{
...
const c_image_stacking_pipeline::sptr & QMasterFrameOptions::current_pipeline() const
{
  return current_pipeline_;
}

//
//void QMasterFrameOptions::set_master_frame_options(c_master_frame_options * options, const c_input_sequence::sptr & input_sequence)
//{
//  options_ = options;
...
//}
//
//const c_input_sequence::sptr & QMasterFrameOptions::input_sequence() const
//{
