...
void CoarseTracker::setCoarseTrackingRef(const std::vector<FrameHessian*> & frameHessians)
{
...
void CoarseDistanceMap::makeDistanceMap(const std::vector<FrameHessian*> & frameHessians, FrameHessian * frame)
{
  int w1 = w[1];
  int h1 = h[1];
  int wh1 = w1 * h1;
