...
class SampleOutputWrapper:
    public Output3DWrapper
{
public:
  ...
  virtual void publishCamPose(c_frame_shell * frame, CalibHessian * HCalib) override
  {
  ...
  virtual void pushDepthImage(const cv::Mat3b & image) override
  {
  ...
  virtual void pushDepthImageFloat(const cv::Mat1f & image, FrameHessian * KF) override
  {
