...
//		else
	...
	AccumulatorXX<8,CPARS>* accE[NUM_THREADS] = {nullptr};
	AccumulatorX<8>* accEB[NUM_THREADS] = {nullptr};
	AccumulatorXX<8,8>* accD[NUM_THREADS] = {nullptr};
	AccumulatorXX<CPARS,CPARS> accHcc[NUM_THREADS];
	AccumulatorX<CPARS> accbc[NUM_THREADS];
	int nframes[NUM_THREADS] = {0};
