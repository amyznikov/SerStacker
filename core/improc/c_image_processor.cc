...
#include "geometry/c_lunar_birdview3_routine.h"
...
#include "quicktests/c_alpha_test_routine.h"
...
void c_image_processor_routine::register_all()
{
  ...
  if ( !registered ) {
    ...
    register_class_factory(c_lunar_birdview3_routine::class_factory_instance());
