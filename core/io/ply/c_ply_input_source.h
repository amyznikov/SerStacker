...
#pragma once
#ifndef __c_ply_input_source_h__
#define __c_ply_input_source_h__

#include <core/io/c_input_source.h>

#define have_ply_input_source 1

class c_ply_input_source :
    public c_input_source
{
public:
  typedef c_ply_input_source this_class;
  typedef c_input_source base;
  typedef std::shared_ptr<this_class> sptr;

  c_ply_input_source(const std::string & filename);
...
#endif /* __c_ply_input_source_h__ */
