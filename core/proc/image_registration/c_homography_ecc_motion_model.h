/*
 * c_homography_ecc_motion_model.h
 *
...
#pragma once
#ifndef __c_homography_ecc_motion_model_h__
#define __c_homography_ecc_motion_model_h__

#include "c_image_transform.h"
#include "ecc2.h"

class c_homography_ecc_motion_model:
    public c_ecc_motion_model_template<c_homography_image_transform>
{
public:
  typedef c_homography_ecc_motion_model this_class;
  typedef c_ecc_motion_model_template<c_homography_image_transform> base;
