...
public:
  ...
  void set_transform(c_translation_image_transform * transform)
  {
    transform_ = transform;
  }

  c_translation_image_transform * transform() const
  {
    return transform_;
  }
...
protected:
  c_translation_image_transform * transform_ = nullptr;
